...
class MovingCategoryPage extends StatelessWidget {
  const MovingCategoryPage({super.key});
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 2),
                    Text("5.0 km", style: TextStyle(fontSize: 12, color: Colors.grey[600])),
                  ],
                ),
                const SizedBox(height: 4),
                Row(
