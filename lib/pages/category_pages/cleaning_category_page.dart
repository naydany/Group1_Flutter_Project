...
class CleaningCategoryPage extends StatelessWidget {
  const CleaningCategoryPage({super.key});
        ...
        children: [
          ClipRRect(
            ...
            child: Container(
              ...
              child: const Icon(Icons.cleaning_services, size: 40, color: Colors.grey),
            ),
          ),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 2),
                    Text("1.8 km", style: TextStyle(fontSize: 12, color: Colors.grey[600])),
                  ],
                ),
                const SizedBox(height: 4),
                Row(
