...
class CarpentryCategoryPage extends StatelessWidget {
  const CarpentryCategoryPage({super.key});
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return _buildCarpenterCard();
        },
      ),
    );
  }

  Widget _buildCarpenterCard() {
    return Container(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 2),
                    Text("4.0 km", style: TextStyle(fontSize: 12, color: Colors.grey[600])),
                  ],
                ),
                const SizedBox(height: 4),
                Row(
